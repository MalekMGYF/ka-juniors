...
export default function MafiosoRoom({ code, onLeave }: Props) {
  ...
  useEffect(() => {
    ...
    ["player_joined", "player_left", "room_closed", "game_started", "role_acknowledged", "boss_intro_started", "clue_announced", "discussion_started", "vote_announcement_started", "voting_started", "message_created", "vote_cast", "vote_resolved", "game_finished"].forEach((event) => channel.on("broadcast", { event }, () => void load()));
    channel.subscribe();
